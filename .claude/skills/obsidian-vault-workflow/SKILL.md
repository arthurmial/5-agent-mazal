...
description: >
  Obsidian Vault Workflow — מערכת זיכרון מתמשך לפרויקט בתיקיית vault/.
  לפני כל משימה: טוען הקשר מקובץ הנושא הרלוונטי.
  אחרי כל משימה: מעדכן Session Log עם מה שנעשה והחלטות שהתקבלו.
---
